...
export default function Diensten() {
  return (
    <div className="w-full">
      ...
      <p className="mb-8 max-w-3xl">We bieden een breed scala aan vakmanschap voor particuliere en kleinschalige zakelijke opdrachten. Hieronder vind je een overzicht van onze belangrijkste diensten.</p>
